                ...
                <div class="card-body">
                    ...
                    <form id="frmInputs" style="margin-top: 3em;">
                        <div class="form-floating">
                            <input type="text" class="form-control" name="txtnmProductname" id="inputnmProductname" placeholder="First Name">
                            <label for="inputnmProductname">Product Name</label>
                        </div>
                        <div class="form-floating">
                            <input type="text" class="form-control" name="txtnmProductprice" id="inputnmProductprice" placeholder="Last Name">
                            <input type="text" name="txtnmProductstatus" value="1" hidden>
                            <label for="inputnmProductprice">Product Price</label>
                        </div>
                    </form>
                    <div class="row">
                        <div class="col-md-6"></div>
                        <div class="col-md-6 d-grid"><button class="btn btn-success" id="btnSave">Save</button></div>
                    </div>
                </div>
            </div>
        </div>
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            ...
            $('#inputnmProductprice').keyup(function(event) {
