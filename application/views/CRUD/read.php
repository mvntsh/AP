                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="d-grid" style="margin-top: 1em;">
                                                        <button class="btn btn-outline-success"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-cart4" viewBox="0 0 16 16">
                            ...
                            response.data.forEach(function(sql){
                                tbody += `
                                    ...
                                    <tr>
                                        ...
                                        <td style="width: 25%; text-align: center;">${sql['productprice']}</td>
                                    </tr>
                                `;
                            })
